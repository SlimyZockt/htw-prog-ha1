...
public class Calculator {
     ...
     */
    public void pressDigitKey(int digit) throws IllegalArgumentException {
        if (digit > 9 || digit < 0) {
     ...
     */
    public void pressUnaryOperationKey(String operation) throws IllegalArgumentException {
        latestValue = Double.parseDouble(screen);
        latestOperation = operation;
     ...
     */
    public void pressEqualsKey() throws IllegalArgumentException {
